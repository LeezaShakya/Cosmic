    ...
    <div class="uk-container">
        <div class="uk-child-width-1-2@m uk-padding-small" uk-height-match="target: .about-content" uk-grid>
            <div class="about-content uk-flex uk-flex-column uk-flex-center">
                <div class="media-500">
                    <img src="assets/img/dmv.jpg" class="uk-image" alt="">
                </div>
            </div>
            <div class="about-content uk-flex uk-flex-column uk-flex-center pl-50">
                ...
                <ul >
                    ...
                    <li><em>Minimum Sum Assured</em>: NRs. 50,000</li>
                    <li><em>Maximum Sum Assured</em>: Depending Upon Source of Income</li>
                    <li><em>Premium Payment Mode</em>: Single, Yearly, Half-Yearly, Quarterly and Monthly</li>
                    <li>ADB/PWB/PTD: Accident only - Available for Age at entry 16 years and above]. Available for full policy term, equal to sum assured but not more than 50,000,000 by payment of additional premium during premium paying term subject to maximum age of 70 years.</li>
                    <li>&nbsp;Policy loan shall be available after the policy acquires paid-up/surrender value. Policy Loan shall be maximum of 90% of the surrender value.</li>
                </ul>
            </div>
            <div>
            </div>
...
<section class="section-padding-page">
    <div class="uk-container uk-position-relative">
        <div class="uk-padding-small ">
            ...
            <h2 class="uk-text-center">Benefit under Cosmic Insurance</h2>
            <div class="uk-margin-medium-top" style="overflow-x:auto;">

                <table border="3" class="uk-table uk-table-small" style="background:white; border-collapse:collapse;  width:100%;">
                    <thead>

                        <tr>
                            <td>
                                <h5 style="text-align:center">&nbsp;Policy Term</h5>
                            </td>
                            <td>
                                <h5 style="text-align:center">Premium Paying Term</h5>
                            </td>
                            <td colspan="2">
                                <h5 style="text-align:center">Survival Benefit (Money Back)</h5>
                            </td>
                            <td>
                                <h5 style="text-align:center">Maturity Payment</h5>
                            </td>
                            <td>
                                <h5 style="text-align:center">In case of death within policy Term</h5>
                            </td>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            ...
                            <td rowspan="2">
                                <p>10 yrs or Single</p>
                            </td>
                            <td>
                                <p>After 4 years</p>
                            </td>
                            <td>
                                <p>30% of Sum Assured</p>
                            </td>
                            <td rowspan="2">
                                <p>40% of Sum Assured plus Bonus</p>
                            </td>
                            <td rowspan="2">
                                <p>In case of single premium mode - 2.5 times of sum assured with bonus of basic assured,<br />
                                    Other payment option- Basic sum assured with bonus</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td rowspan="3">
                                <p>14 yrs or Single</p>
                            </td>
                            <td>
                                <p>After 4 years</p>
                            </td>
                            <td>
                                <p>20% of Sum Assured</p>
                            </td>
                            <td rowspan="3">
                                <p>40% of Sum Assured plus Bonus</p>
                            </td>
